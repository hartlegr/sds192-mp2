...
Though the function works, we weren't able to apply it to any year besides 2012 (shown below). The dataset provided on information on canidates on the *last* year that they ran for office, so an incumbent who has been in office since the 1990s would only show up in 2012. This results in a lot of the data needed for this function being not available. 
